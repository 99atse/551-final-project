...
-- Uncomment and run these commands separately if you need to create the database:
-- CREATE DATABASE event_db;
-- Then connect to event_db and run the rest of this script

-- Comment the line below if you already have the db created
CREATE DATABASE event_db;
...
/* Create venues table FIRST (no dependencies) */
CREATE TABLE venues (
