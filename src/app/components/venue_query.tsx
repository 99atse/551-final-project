    ...
    <div className="min-h-screen bg-background p-6">
      ...
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Viewing as:{" "}
          <span className="font-medium text-foreground">Event Organizer</span> - Use
          the filters below to query venues
        </p>
      </div>
      ...
      <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
        <Card>
          <CardHeader>
            ...
            <CardDescription>Search for venues to book</CardDescription>
          </CardHeader>

          <CardContent className="space-y-3">
            <div>
              <Label htmlFor="searchTerm">Venue Name</Label>
              <Input
                id="searchTerm"
                placeholder="e.g. Hollywood Bowl"
            ...
            <div>
              <Label htmlFor="bookingTimeRange">Time</Label>
              <Input
                id="bookingTimeRange"
                placeholder="e.g. 12:00-18:00"
                value={filters.bookingTimeRange}
                onChange={(e) =>
                  setFilters({ ...filters, bookingTimeRange: e.target.value })
                }
              />
            </div>
                  ...
                  <Card key={`${venue.venue_id}-${venue.booking_time_range ?? "no-time"}`}>
                    ...
                    <CardContent>
                      <div className="grid grid-cols-2 gap-4 text-sm md:grid-cols-3">
                        ...
                        <div>
                            ...
                            {(() => {
                                ...
                                const sameDay =
                                time.start.toDateString() === time.end.toDateString()
                      ...
                      <Badge variant="outline">
                        Avg Event Rating: ⭐{" "}
                        {venue.avg_event_rating ? Number(venue.avg_event_rating).toFixed(1) : "N/A"}
                      </Badge>
